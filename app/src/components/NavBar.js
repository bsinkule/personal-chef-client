...
const NavBar = (props) => {
  ...
  return (
    <MainWrapper>
      ...
      <li className="media li"><Link style={{ textDecoration: 'none', color: 'black' }} to="/Home">home</Link></li>
      <li className="media li"><Link style={{ textDecoration: 'none', color: 'black' }} to="/Pics">pics</Link></li>
      ...
      <li className="media li"><Link style={{ textDecoration: 'none', color: 'black' }} to="/About">about</Link></li>
